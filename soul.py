...
FORWARD_CHANNEL_ID = -1002233392193
CHANNEL_ID = -1002233392193
error_channel_id = -1002233392193
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https:/99*", parse_mode='Markdown')
